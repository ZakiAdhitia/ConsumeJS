...
<div className="relative overflow-x-auto shadow-md px-20 py-10">
                    <div className="flex justify-end">
                        <Link to="/inboundStuff" className="inline-flex items-center px-4 py-2 text-sm font-medium 
    ...
    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    <h2 class="mb-4 text-xl font-bold text-white dark:text-white">Add a new Inbound Stuff Data</h2>
                    {
                        alert ? (
                            ...
                            role="alert">
                                <span class="font-medium">Success!</span> check inboun data in <b><Link>this pages</Link></b>.
                            </div>
                        ) : ''
                    }
                    {
