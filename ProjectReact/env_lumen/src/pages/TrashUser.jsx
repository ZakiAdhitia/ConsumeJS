...
export default function TrashUser() {
    ...
    <div className="relative overflow-x-auto shadow-md px-20 py-10">
        ...
        <Table headers={headers} data={userTrash} endpoint={endpointModal} inputData={inputData} titleModal={tittle} indentitasColumn={columnIdentitasDelete} opsiButton={buttons} 
